...
#define PEN  		PCin(5)    	//PB1--TPEN,
#define DOUT 		PBin(14)     //PB2--T-MISO  初始化设置
#define TDIN 		PBout(15)  	//PF11--T-MOSI
#define TCLK 		PBout(13)  	//PB0--TSCK,  初始化设置
#define TCS  		PBout(12)  	//PC13--T-CS
