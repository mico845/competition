...
#define LMX2571_FDV 	PBout(1)
#define LMX2571_FD2 	PCout(5)
#define LMX2571_FD1 	PAout(7)
#define LMX2571_FD0 	PAout(3)
#define LMX2571_CLK 	PCout(3)
#define LMX2571_LE 		PDout(13)
#define LMX2571_CE 		PCout(0)
#define LMX2571_MUX 	PBin(2)
#define LMX2571_DATA 	PCout(2)
#define LMX2571_TRCTL   PBout(0)
