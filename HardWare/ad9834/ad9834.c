...
void AD9834_WriteBytes(uint16_t data)
{
	...
	{
		if(data & 0x8000)
			AD9834_SDATA_SET;// Write On 1
		else
			AD9834_SDATA_RESET;// Write On 0
...
void AD9834_Init(void)
{
    ...
    AD9834_WriteBytes(0x2100);
    AD9834_WriteBytes(0x2038);
    AD9834_WriteBytes(0XC000);
    AD9834_WriteBytes(0x2100);

}

void AD9834_SetFreq(uint8_t Freq_Num,unsigned long  freq)
{
