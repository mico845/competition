...
/************************************************************
** 函数名称 void AD9959_IO_Update(void)
** 函数功能 ： AD9959更新数据
**************************************************************/
...
{
    AD9959_PS0=1;AD9959_PS1=1;AD9959_PS2=1;AD9959_PS3=1;//PS0-PS3分别控制CH0-CH3；高电平：从起始值扫到结束值
    delay_ms(nms);
    AD9959_PS0=0;AD9959_PS1=0;AD9959_PS2=0;AD9959_PS3=0;//低电平：从结束值扫到起始值
    delay_ms(nms);
}
